...
def verify(img1_path, img2_path = '', model_name = 'VGG-Face', distance_metric = 'cosine', model = None, enforce_detection = True, detector_backend = 'mtcnn', fast = False):
		...
		if type(instance) == list and len(instance) >= 2:
			...
			for i in  model_names:
				...
				img1_representation = represent(img_path = img1_path
						...
						, enforce_detection = enforce_detection, detector_backend = detector_backend, fast=fast)
...
def represent(img_path, model_name = 'VGG-Face', model = None, enforce_detection = True, detector_backend = 'mtcnn', fast = False):
	...
	#detect and align
	if fast: 
		img = functions.preprocess_face_fast(img = img_path
